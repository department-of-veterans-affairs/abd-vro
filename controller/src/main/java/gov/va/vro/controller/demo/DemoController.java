...
public class DemoController implements DemoResource {
  ...
  private final AssessHealthDataRequestMapper mapper;

  public DemoController(CamelEntrance camelEntrance, AssessHealthDataRequestMapper mapper) {
  ...
  public ResponseEntity<AssessHealthDataResponse> assess_health_data(
    ...
    AssessHealthData model = mapper.toModel(request);
    ...
    AssessHealthDataResponse responseObj = mapper.toAssessHealthDataResponse(model);
