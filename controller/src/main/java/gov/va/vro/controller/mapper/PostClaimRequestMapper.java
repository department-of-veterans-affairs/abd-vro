...
public interface PostClaimRequestMapper {
  ...
  // Requests from v1 include a claimSubmissionId. This is equivalent to the referenceId on the
  // claimSubmission table, which is equivalent to a collection Id from MAS
