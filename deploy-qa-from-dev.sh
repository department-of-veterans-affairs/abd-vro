...
docker pull "ghcr.io/${github_repository}/dev_vro-initdb:${COMMIT_SHA:0:7}"
...
docker tag "ghcr.io/${github_repository}/dev_vro-initdb:${COMMIT_SHA:0:7}" "ghcr.io/${github_repository}/qa_vro-initdb:${COMMIT_SHA:0:7}"
...
docker tag "ghcr.io/${github_repository}/dev_vro-initdb:${COMMIT_SHA:0:7}" "ghcr.io/${github_repository}/qa_vro-initdb:latest"
...
docker push -a ghcr.io/${github_repository}/qa_vro-initdb
...
docker rmi ghcr.io/${github_repository}/qa_vro-postgres:${COMMIT_SHA:0:7} \
            ...
            ghcr.io/${github_repository}/qa_vro-initdb:${COMMIT_SHA:0:7} \
            ...
            ghcr.io/${github_repository}/qa_vro-initdb:latest \
