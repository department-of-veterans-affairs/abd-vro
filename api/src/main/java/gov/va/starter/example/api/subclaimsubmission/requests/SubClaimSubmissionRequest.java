package gov.va.starter.example.api.subclaimsubmission.requests;
...
public class SubClaimSubmissionRequest {
   ...
   *
   * @param userName username of SubClaimSubmission holder
   * @param pii private information of SubClaimSubmission holder
   * @param firstName firstname of SubClaimSubmission holder
   * @param lastName lastname of SubClaimSubmission holder
   */
  @JsonCreator
