...
import org.openapitools.model.ClaimSummary;
...
public class ClaimsTest {
  ...
  void happyPathTest() {
    ...
    ResponseEntity<ClaimDetailResponse> response = restTemplate.getForEntity(url, ClaimDetailResponse.class);
    ...
    ResponseEntity<ContentionSummariesResponse> response2 = restTemplate.getForEntity(urlContentions, ContentionSummariesResponse.class);
