...
class ExampleClaimSubmissionApiSimulation extends Simulation {
  ...
  val scn = scenario("API Endpoint Simulation")
    .exec(http("Create ClaimSubmission")
    ...
    .exec(http("Get ClaimSubmission")
      .get("/v1/example/claimsubmissions/${userId}")) // 92534752-a39c-499c-aa13-528cd0143f7c
    .exec(http("Create SubClaimSubmission")
      .post("/v1/example/claimsubmissions/${userId}/subclaimsubmissions")
    ...
    .exec(http("Get SubClaimSubmission")
      .get("/v1/example/claimsubmissions/${userId}/subclaimsubmissions/${subUserId}")) // 92534752-a39c-499c-aa13-528cd0143f7c
