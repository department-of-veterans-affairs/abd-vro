...
@pytest.mark.parametrize("starting_state", [state for state in JobState.incomplete_states() if state not in [JobState.RUNNING_CANCEL_EP400_CLAIM, JobState.RUNNING_ADD_CLAIM_NOTE_TO_EP400]])
class TestRestart:
    class TestSuccess:
