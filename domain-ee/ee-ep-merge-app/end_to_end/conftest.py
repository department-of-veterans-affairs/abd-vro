...
def lifecycle_endpoint():
    client = AsyncHoppyClient(
        ...
        request_queue_properties=QueueProperties(name='putClaimLifecycleStatusQueue', passive_declare=False, arguments={'x-dead-letter-exchange': EXCHANGES[ClientName.BIP_DEAD_LETTER]}),
