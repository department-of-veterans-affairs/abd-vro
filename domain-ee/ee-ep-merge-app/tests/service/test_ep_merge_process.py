...
class TestUpToGetPendingContentions:
    ...
    def test_invalid_request_at_get_ep400_contentions_after_get_pending_contentions_failure(
        ...
        assert_metrics_called(
            metric_logger_distribution, metric_logger_increment, JobState.COMPLETED_ERROR, JobState.GET_PENDING_CLAIM_CONTENTIONS_FAILED_REMOVE_SPECIAL_ISSUE
        )
...
class TestUpToSetTemporaryStationOfJurisdiction:
    ...
    def test_invalid_request_on_update_contentions_after_set_tsoj_failure(
        ...
        assert_metrics_called(
            metric_logger_distribution, metric_logger_increment, JobState.COMPLETED_ERROR, JobState.SET_TEMP_STATION_OF_JURISDICTION_FAILED_REMOVE_SPECIAL_ISSUE
        )
...
class TestUpToMoveContentionsToPendingClaim:
    ...
    def test_fail_to_revert_tsoj_after_failure_to_move_contentions_to_pending_claim(
        ...
        assert_metrics_called(
            metric_logger_distribution, metric_logger_increment, JobState.COMPLETED_ERROR, JobState.MOVE_CONTENTIONS_FAILED_REVERT_TEMP_STATION_OF_JURISDICTION
        )
