...
class EpMergeMachine(StateMachine):
    ...
    def on_get_supplemental_contentions(self, pending_contentions=None, tsoj_response=None):
        logging.info(f"tsoj={tsoj_response}")
    ...
    def on_merge_contentions(self, pending_contentions=None, supplemental_contentions=None):
        ...
        try:
            merged_contentions = ClaimsUtil.merge_claims(pending_contentions, supplemental_contentions)
    ...
    def make_request(self,
                     ...
                     hoppy_client,
                     response_type: Type[GeneralResponse] | None = None):
        logging.info(request.model_dump(by_alias=True))
        try:
