...
public class AbdApplicationIT {    
    ...
    private static final DockerImageName rabbitmqImageName = DockerImageName.parse("rabbitmq:3-management-alpine");
    @Container
    private static RabbitMQContainer rabbitMqContainer = new RabbitMQContainer(rabbitmqImageName)
    ...
    void testForClaim01() throws Exception {
        ...
        AbdResponse response = template.requestBody("direct:access_medical_data", body, AbdResponse.class);
