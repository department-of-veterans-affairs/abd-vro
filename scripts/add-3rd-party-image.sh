...
# To work around https://www.docker.com/increase-rate-limits/, this script publishes the
# specified image to GHCR and optionally creates a helm configuration for the service.
