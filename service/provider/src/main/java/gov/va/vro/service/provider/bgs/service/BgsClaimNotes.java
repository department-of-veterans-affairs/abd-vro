...
public class BgsClaimNotes {
  ...
  public static final String RFD_NOTE = "Claim status updated to RFD via automation";

  public static final String ARSD_COMPLETED_NOTE =
  ...
  public static final String EXAM_REQUESTED_NOTE =
  ...
  public static final String CANT_CONFIRM_PRESUMPTIVE_NOTE =
  ...
  public static final String ARSD_NOT_UPLOADED_NOTE =
      "Claim was offramped from VBA automation platform when ARSD could not be uploaded to eFolder.";

  public static final Map<String, String> OFFRAMP_ERROR_2_CLAIM_NOTE =
      Map.of(
